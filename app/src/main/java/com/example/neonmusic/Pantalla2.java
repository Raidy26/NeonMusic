...
public class Pantalla2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add("El alfa- Mera wooo");
        arrayList.add("Anuel aa ft ozuna- Cambio");
        arrayList.add("Secreto- La vuelta");
        arrayList.add("Sech- Relaciones");
        arrayList.add("Rochy rd- Infeliz");
